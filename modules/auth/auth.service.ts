...
const REFRESH_TOKEN_EXPIRY = '365d'; // FIX: 1 év, nem 30 nap

// Az összes létező permission – szinkronban kell tartani a shared/types/index.ts-sel
...
export async function loginUser(
  ...
  try {
    ...
    // Superuser automatikusan minden jogot megkap (ALL_PERMISSIONS alapján)
